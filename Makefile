...
index:   ; $(CC) $(__LDFLAGS__) -o $@ src/index.o    src/cd.o src/date_to_text.o src/stoi.o
blogify: ; $(CC) $(__LDFLAGS__) -o $@ src/blogify.o  src/cd.o src/date_to_text.o src/stoi.o src/htmlize.o
htmlize: ; $(CC) $(__LDFLAGS__) -o $@ .htmlize.o              src/date_to_text.o src/stoi.o src/htmlize.o
